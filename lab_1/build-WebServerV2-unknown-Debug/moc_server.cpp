...
QT_MOC_LITERAL(1, 11, 12), // "PrintMessage"
QT_MOC_LITERAL(2, 24, 0) // ""

    },
    "HttpServer\0PrintMessage\0"
};
...
void HttpServer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (HttpServer::*_t)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&HttpServer::PrintMessage)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject HttpServer::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_HttpServer.data,
...
// SIGNAL 0
void HttpServer::PrintMessage(QString _t1)
{
